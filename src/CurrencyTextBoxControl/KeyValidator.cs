...
namespace CurrencyTextBoxControl
{
    public static class KeyValidator
    {
        ...
        public static bool IsPointKey(Key key) => key == Key.OemPeriod || key == Key.OemComma || key == Key.Decimal;
        ...
        public static bool IsPlusKey(Key key) => key == Key.Add || key == Key.OemPlus;
